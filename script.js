...
const distances = [1, 1.85, 2.56, 3.90, 13.33, 24.56, 49.28, 77.05];
const mercury_rad = 5;
const delay = 100;
...
let planet_x = [0, 0, 0, 0, 0, 0, 0, 0];
let planet_y = [0, 0, 0, 0, 0, 0, 0, 0];
...
let time = 0;
const rel_periods = [1, 2.58, 4.17, 7.83, 49.42, 122.75, 350, 686.67];
